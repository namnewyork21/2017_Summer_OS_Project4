...
static FileTransfer *
_getfile_1 (FileTransfer  *argp, struct svc_req *rqstp)
{
	return (getfile_1_svc(*argp, rqstp));
}
...
minifyjpeg_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case GetFile:
		_xdr_argument = (xdrproc_t) xdr_FileTransfer;
		_xdr_result = (xdrproc_t) xdr_FileTransfer;
		local = (char *(*)(char *, struct svc_req *)) _getfile_1;
		break;
